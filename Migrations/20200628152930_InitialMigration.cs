    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ads", x => x.AddId);
                    table.ForeignKey(
                        name: "FK_Ads_PetCategories_PetCategoryId",
                        column: x => x.PetCategoryId,
                        principalTable: "PetCategories",
                        principalColumn: "PetCategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ads_PetTypes_PetTypeId",
            ...
            migrationBuilder.InsertData(
                table: "PetCategories",
                columns: new[] { "PetCategoryId", "CategoryName", "Description" },
                values: new object[,]
                {
                    { 1, "Lost", null },
                    { 2, "Found", null }
            ...
            migrationBuilder.InsertData(
                table: "PetTypes",
                columns: new[] { "PetTypeId", "TypeDescription", "TypeName" },
                values: new object[,]
                {
                    { 1, null, "Cats" },
                    { 2, null, "Dogs" },
                    { 3, null, "Birds" },
                    { 4, null, "Large animals" },
                    { 5, null, "Others" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Ads_PetCategoryId",
                table: "Ads",
